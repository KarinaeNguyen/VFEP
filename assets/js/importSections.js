(() => {
  const LANGUAGE_DATA = {
    vi: {
      ...
      overview_card1_body:
        "Đạn chữa cháy 0.68-cal không ăn mòn, kích hoạt bằng động năng thấp.",
      overview_card2_title: "Mô hình kinh doanh",
      overview_card2_body:
        "Asset-light, tập trung vào cấp phép IP và dịch vụ hỗ trợ kỹ thuật.",
      overview_card3_title: "Thị trường ban đầu",
      overview_card3_body:
        "Trung tâm dữ liệu, sản xuất điện tử và kho pin Lithium-ion.",
      ...
      lean_card1_body:
        "Thiệt hại do nước/khí, cháy pin Li-ion và sự chậm chạp của hệ thống truyền thống.",
      lean_card2_title: "Giải pháp",
      lean_card2_body:
        "Đạn VFEP + Purple K siêu mịn + phần mềm nhắm mục tiêu chính xác.",
      ...
      tech_section_intro:
        "Ba thành phần chính phối hợp: đạn, tác nhân chữa cháy và cảm biến/AI.",
      ...
      strategy_card1_body:
        "IP giữ tại Singapore, R&D tại Việt Nam để tối ưu chi phí và pháp lý.",
      strategy_card2_title: "Doanh thu hai tầng",
      strategy_card2_body:
        "Phí cấp phép trả trước + royalty trên mỗi hệ thống đối tác bán ra.",
      strategy_card3_title: "Lộ trình MVP",
      strategy_card3_body:
        "Ưu tiên thử nghiệm thực địa, dùng linh kiện sẵn có để giảm rủi ro.",
      ...
      adv_section_intro:
        "Chiến lược “vi mô” tạo ngách bảo vệ tài sản mà đối thủ chưa khai thác.",
      adv_tab1_btn: "Phân tích đối thủ",
      adv_tab2_btn: "USP cốt lõi",
      adv_tab1_title: "Đối thủ hiện tại",
      adv_tab1_list1:
        "Hệ thống khí Stat-X: bao phủ cả phòng, tốn chi phí niêm kín.",
      ...
      footer_note:
        "© 2025 Vicinity Safety. Dự án R&D công nghệ chữa cháy chính xác tại Việt Nam.",
    },
    en: {
      ...
      overview_card1_body:
        "0.68-cal non-corrosive firefighting rounds triggered with low kinetic energy.",
      ...
      overview_card3_body:
        "Data centers, electronics manufacturing, and lithium-ion battery depots.",
      ...
      lean_card1_body:
        "Water/gas damage, Li-ion thermal runaway, and slow legacy systems.",
      lean_card2_title: "Solution",
      lean_card2_body:
        "VFEP projectile + micronized Purple K + precision targeting software.",
      lean_card3_title: "Revenue",
      lean_card3_body:
        "Upfront licensing fees, recurring royalties, and integration consulting.",

      tech_section_title: "Core technology",
      tech_section_intro:
        "Three synchronized components: projectile, agent, and sensing/AI.",
      ...
      strategy_card1_body:
        "Hold IP in Singapore, run R&D in Vietnam for cost and legal efficiency.",
      ...
      strategy_card3_body:
        "Prioritize live pilots using off-the-shelf hardware to de-risk.",
      ...
      market_section_intro:
        "“Ground first, orbit later” builds data and certifications step by step.",
      ...
      market_tab1_list3:
        "UPS/ESS battery rooms facing thermal runaway risks.",
      ...
      fin_section_intro:
        "8-quarter cash-flow outlook based on current licensing pipeline.",
      ...
      adv_section_intro:
        "Our “micro” approach protects assets where others cannot.",
      ...
      footer_note:
        "© 2025 Vicinity Safety. Precision fire R&D project based in Vietnam.",
    },
  };
    ...
    const fetches = sections.map((section) =>
      fetch(`sections/${section}.html`)
        .then((res) =>
          res.ok
            ? res.text()
            : `<p class="text-red-600">Không thể tải ${section}</p>`
        )
  ...
  function applyTranslations(lang) {
    ...
    // This checks the current lang and sets the button to switch to the *other* lang
