// This is the COMPLETE file for assets/js/importSections.js
(() => {
  const LANGUAGE_DATA = {
    'vi': {
...
A       'tech_proj_row10_p2': 'Note: Reliant on precise aim at the base of the fire.',
...
s       'tech_sensor_l1_strong': 'Sensors:',
...
  S     'strategy_h2': '2. Revenue Model (High-Margin)',
...
s     'strategy_h_value_prop': 'Value Proposition',
...
  s   'market_ground_item3_strong': 'VFEP Solution:',
...
s     'footer_text': '© 2025 Vicinity Safety. All intellectual property rights are in the process of registration.',
    }
  };
...
      
      // ✅ --- START FIX ---
      // Fire the 'sectionsLoaded' event.
      // This tells tabs.js and main_v11.js that it is safe to run.
...
    // ✅ FIX: Make data available to other scripts like main_v11.js
...
    if (switchBtn) {
    Type   const targetLang = lang === 'vi' ? 'en' : 'vi';
      // FIX: This is the correct, simple way to add the click event
...
  }
  
  // ✅ FIX: Make applyTranslations globally accessible for main_v11.js
  window.applyTranslations = () => applyTranslations(currentLang);
  // ---

  window.switchLanguage = function(lang) {
  S   if (lang === currentLang) return;
    currentLang = lang;
is-invalid.
